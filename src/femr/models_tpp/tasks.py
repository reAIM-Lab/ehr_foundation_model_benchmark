...
class Task(abc.ABC):
    ...
    @abc.abstractmethod
    def get_task_config(self) -> femr.models_tpp.config.FEMRTaskConfig: ...
...
class LabeledSubjectTask(Task):
    ...
    def get_task_config(self) -> femr.models_tpp.config.FEMRTaskConfig:
        return femr.models_tpp.config.FEMRTaskConfig(task_type="labeled_subjects")
...
class CLMBRTask(Task):
    ...
    def get_task_config(self) -> femr.models_tpp.config.FEMRTaskConfig:
        return femr.models_tpp.config.FEMRTaskConfig(
...
class MOTORTask(Task):
    ...
    def fit_pretraining_task_info(
            ...
            tokenizer: femr.models_tpp.tokenizer.HierarchicalTokenizer,
            num_tasks: int,
            num_bins: int,
        ...
        return MOTORTask(task_data, non_numerical_time_bins, numerical_time_bins, final_layer_size, value_bins, value_valid_mask, num_value_bins, numerical_task_list)
