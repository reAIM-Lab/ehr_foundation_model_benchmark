...
The cohort definitions above are OHDSI Atlas / OMOP cohorts. For the MIMIC-IV (MEDS) phenotype cohorts (AMI, MASLD, stroke), see [`mimic/`](./mimic), extracted from [reAIM-Lab/mimic_phenotype_cohort](https://github.com/reAIM-Lab/mimic_phenotype_cohort).