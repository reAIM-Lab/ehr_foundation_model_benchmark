...
OUTPUT_FIX2_LARGE_XGB = os.path.join(BASE_ROOT, "models/meds_tab/output-fix2-large-xgb")

TASKS = ["long_los", "death", "readmission"]
SAMPLE_SIZES = [1000, 100, 10000] #[10000, 1000, 100]
...
def main():
    for task in TASKS:
        ...
        probing_output = os.path.join(OUTPUT_FIX2_LARGE, f"{task}_probing_xgb")
