...
OUTPUT_MODEL_DIR = os.path.join(BASE_PATH, "models/meds_tab/output-fix2-large-sample")
TASKS_DIR = os.path.join(BASE_PATH, "models/meds_tab/labels-fix2-large-sample")
N_PARALLEL_WORKERS = 16 #32 #32 #64 #32 #32 #4
...
# phenotype_tasks = list(sorted(glob.glob(os.pjath.join(PHENOTYPE_PATH, "*.parquet"))))
# print(phenotype_tasks)
# exit()
...
"""
python -m memray run -o output.bin -m MEDS_tabular_automl.scripts.tabularize_time_series input_dir=/data2/processed_datasets/ehr_foundation_data/ohdsi_cumc_deid/ohdsi_cumc_deid_2023q4r3_v3_mapped/post_transform/data output_dir=/data2/processed_datasets/ehr_foundation_data/ohdsi_cumc_deid/ohdsi_cumc_deid_2023q4r3_v3_mapped/models/meds_tab/output-fix2-large/CLL_final do_overwrite=False input_label_dir=/data2/processed_datasets/ehr_foundation_data/ohdsi_cumc_deid/ohdsi_cumc_deid_2023q4r3_v3_mapped/models/meds_tab/labels-fix2-large/CLL tabularization.aggs=[code/count,value/count,value/sum,value/sum_sqd,value/min,value/max] tabularization.window_sizes=[1d,7d,30d,60d,365d,full]

MEDS_tabular_automl.scripts.tabularize_time_series:main
python -m memray run -o output.bin /data/mchome/ffp2106/MEDS_Tabular_AutoML/src/MEDS_tabular_automl/scripts/tabularize_time_series.py input_dir=/data2/processed_datasets/ehr_foundation_data/ohdsi_cumc_deid/ohdsi_cumc_deid_2023q4r3_v3_mapped/post_transform/data output_dir=/data2/processed_datasets/ehr_foundation_data/ohdsi_cumc_deid/ohdsi_cumc_deid_2023q4r3_v3_mapped/models/meds_tab/output-fix2-large/CLL_final do_overwrite=False input_label_dir=/data2/processed_datasets/ehr_foundation_data/ohdsi_cumc_deid/ohdsi_cumc_deid_2023q4r3_v3_mapped/models/meds_tab/labels-fix2-large/CLL tabularization.aggs=[code/count,value/count,value/sum,value/sum_sqd,value/min,value/max] tabularization.window_sizes=[1d,7d,30d,60d,365d,full]
"""