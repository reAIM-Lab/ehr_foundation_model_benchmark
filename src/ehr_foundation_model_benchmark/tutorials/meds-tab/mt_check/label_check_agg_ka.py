...
# path_gen_labels = f"/data2/processed_datasets/ehr_foundation_data/ohdsi_cumc_deid/ml4h_demo/ohdsi_cumc_deid_2023q4r3_10000_sample_meds_unit_concatenated/task_labels/long_los_sharded"
# path_gen_tab = f"/data2/processed_datasets/ehr_foundation_data/ohdsi_cumc_deid/ml4h_demo/meds-tab_check/models_mic1_task_tiny_0.1_{k}/long_los_output{suffix}/tabularize"
# path_gen_mt = f"/data2/processed_datasets/ehr_foundation_data/ohdsi_cumc_deid/ml4h_demo/meds-tab_check/models_mic1_task_tiny_0.1_{k}/long_los_output{suffix}/metadata"
...
path_task_tab = f"/data2/processed_datasets/ehr_foundation_data/ohdsi_cumc_deid/ml4h_demo/meds-tab_check/models_mic1_task_tiny_0.1_{k2}/long_los_output{suffix2}/tabularize"
path_task_mt = f"/data2/processed_datasets/ehr_foundation_data/ohdsi_cumc_deid/ml4h_demo/meds-tab_check/models_mic1_task_tiny_0.1_{k2}/long_los_output{suffix2}/metadata"
    ...
    for gen_path, task_path, ext in matches:
        ...
        if ext == "parquet":
            ...
            for file in gen_files.intersection(task_files):
                ...
                # gen_df['label'] = gen_df['boolean_value']
                # gen_df['time'] = gen_df['prediction_time']
