...
OUTPUT_MODEL_DIR = os.path.join(BASE_PATH, "meds-tab_check/models-0.0.9")
TASKS_DIR = os.path.join(BASE_PATH, "meds-tab_check/tasks-0.0.9")
...
for i, task in (pbar := tqdm(enumerate(phenotype_tasks))):
    ...
    xgboost_cmd = [
        ...
        # f"input_label_cache_dir={os.path.join(OUTPUT_MODEL_DIR, task + '_final', task + '_task', 'task_cache')}",
        "tabularization.aggs=[code/count]",
        "tabularization.window_sizes=[full]",
