...
Usage:
python create_desc.py  --dataset MEDSDataset --path_to_dataset_config /home/zj2398@mc.cumc.columbia.edu/ICL_EHR/hf_ehr/configs/data/meds_mimic4.yaml --path_to_tokenizer_config /home/zj2398@mc.cumc.columbia.edu/ICL_EHR/hf_ehr/configs/tokenizer/desc.yaml --path_to_cache_dir '/data/processed_datasets/processed_datasets/zj2398/hf_cache/create_desc/' --n_procs 128 --chunk_size 10000 --is_force_refresh  
"""

import os
import argparse
import time
from utils import add_unique_codes, add_occurrence_count_to_codes, remove_codes_belonging_to_vocabs
...
DEFAULT_PATH_TO_CACHE_DIR: str = '/data/processed_datasets/processed_datasets/zj2398/hf_cache/create_desc/'
...
def main():
    ...
    call_func_with_logging(add_occurrence_count_to_codes, 'add_occurrence_count_to_codes', path_to_tokenizer_config, pids=pids, path_to_cache_dir=args.path_to_cache_dir, dataset=args.dataset, split='train', n_procs=args.n_procs, chunk_size=chunk_size, path_to_extract=path_to_extract, dataset_cls=dataset_cls,tokenizer_name="desc")
    tokenizer_config, _ = load_tokenizer_config_and_metadata_from_path(path_to_tokenizer_config)
